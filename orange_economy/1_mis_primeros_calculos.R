...
# Se consideran atipicos(outliers) los valores inferiores a (Q1-1.5�RIC) o superiores a (Q3+1.5�RIC)
# Se pueden considerar valores extremadamente atipicos aquellos que exceden (Q1- 3�RIC) o (Q3+3�RIC)
